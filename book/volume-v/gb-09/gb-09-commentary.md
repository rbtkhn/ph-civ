...
- Transfer analysis summary: The transfer analysis and evidence pack place this chapter around Dante, Divine Comedy, Virgil, Beatrice, love, ascent, Christian imagination, classical inheritance, and poetic architecture.
...
- Transcript authority: gb-09-transcript.md contains the transferred `## Full transcript` body from strategy-codex.
- Transfer analysis authority: `analysis/4EZUrGPgAos-great-books-09-analysis.md` provides the first-pass analysis used to shape this in-review commentary.
- Evidence-pack authority: `evidence-packs/gb-ch09.md` provides the book-track source and claim routing for `gb-ch09`.
