...
- Public scaffold summary: The public scaffold places this chapter around poets, prophets, sacred speech, literary authority, communal memory, religion, and world-making language.
...
- Transcript authority: gb-03-transcript.md contains the public `## Full transcript` body from the import snapshot.
