...
This chapter folder is a public study doorway for `sh-12`.
...
- [Transcript](sh-12-transcript.md)
- [Commentary canvas](sh-12-commentary.md)
- [Orientation payload](sh-12-orientation.yaml)
