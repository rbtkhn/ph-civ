...
This chapter folder is a public study doorway for `sh-22`.
...
- [Transcript](sh-22-transcript.md)
- [Commentary canvas](sh-22-commentary.md)
- [Orientation payload](sh-22-orientation.yaml)
