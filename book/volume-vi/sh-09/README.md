...
This chapter folder is a public study doorway for `sh-09`.
...
- [Transcript](sh-09-transcript.md)
- [Commentary canvas](sh-09-commentary.md)
- [Orientation payload](sh-09-orientation.yaml)
