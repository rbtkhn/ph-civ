...
This chapter folder is a public study doorway for `sh-26`.
...
- [Transcript](sh-26-transcript.md)
- [Commentary canvas](sh-26-commentary.md)
- [Orientation payload](sh-26-orientation.yaml)
