...
This chapter folder is a public study doorway for `sh-16`.
...
- [Transcript](sh-16-transcript.md)
- [Commentary canvas](sh-16-commentary.md)
- [Orientation payload](sh-16-orientation.yaml)
