...
These are reading overlays, not chapter authorities.

Start with the [interwoven civilization spine](../interwoven-reader/README.md) for the canonical Volume I reading order. [Volume I Parts](../parts/README.md) index spine slices; these route notes deepen or cross that order, not replace it.

- [Part boundary tour](../../../data/routes/part-boundary-tour.json) — ten stops at each Part `spine_start`
