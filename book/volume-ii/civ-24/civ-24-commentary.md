...
|------------|----------|--------------------|-------------|-----------------------------------|-------|
| The next chapter will argue Paul transforms Jesus movement into Christianity. | E | Later material does not follow this expectation, or final review finds the lecture did not support it. | 2026-05-13 | Pending | In-review control. |
| Later monotheism chapters should keep historical Jesus, biblical Jesus, Gnostic Jesus, and Pauline Christianity distinct. | C | Later material does not follow this expectation, or final review finds the lecture did not support it. | 2026-05-13 | Pending | In-review control. |
...
|------------------|-----------|----------------------|------------------------------|
| Historical Jesus, biblical Jesus, and Gnostic Jesus must remain distinct source layers. | `civ-24-transcript.md` | Keeps the in-review chapter bounded. | High |
| Claims about original sin, Yahwist interpretation, and Gnosticism require theological and textual review. | `civ-24-transcript.md` | Keeps the in-review chapter bounded. | High |
| The phrase that Jews killed Jesus is historically and ethically high-risk; Roman authority and intra-Jewish diversity must stay visible. | `civ-24-transcript.md` | Keeps the in-review chapter bounded. | High |
| Paul-founded-Christianity is a strong lecture thesis, not a settled final scholarly claim. | `civ-24-transcript.md` | Keeps the in-review chapter bounded. | High |
...
- Connection to `civ-23`: messianic and eschatological categories shape how Jesus can be interpreted.
- Connection to `civ-25`: Paul becomes the next transformation point from Jesus memory to Christianity.
- Broader pattern: religious founders are often reconstructed through competing memory layers after death.
