...
|------------------|-----------|----------------------|------------------------------|
| Explaining Mongol brutality must remain clearly separate from endorsement or minimization. | civ-39-transcript.md | Keeps the in-review chapter bounded. | High |
| Steppe culture and agricultural empire contrasts are broad and need external review. | civ-39-transcript.md | Keeps the in-review chapter bounded. | High |
| Claims about openness, assimilation, and specialist use require source checking. | civ-39-transcript.md | Keeps the in-review chapter bounded. | High |
| Proto-Indo-European and mythology-value claims are interpretive and should remain bounded. | civ-39-transcript.md | Keeps the in-review chapter bounded. | High |
