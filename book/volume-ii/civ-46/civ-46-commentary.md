...
|------------------|-----------|----------------------|------------------------------|
| The four-worldview sequence is a sweeping model and should not become a complete history of religion. | civ-46-transcript.md | Keeps the in-review chapter bounded. | High |
| Rousseau, deism, civil religion, and Enlightenment claims require textual and historical review. | civ-46-transcript.md | Keeps the in-review chapter bounded. | High |
| The nation-as-religion argument is productive but should be bounded, especially for later war claims. | civ-46-transcript.md | Keeps the in-review chapter bounded. | High |
| This chapter starts a sequence; Robespierre and Napoleon material should be used later to test and refine the frame. | civ-46-transcript.md | Keeps the in-review chapter bounded. | High |
...
- Connection to civ-45: gunpowder and state formation prepare the institutional world that Enlightenment and revolution transform.
- Connection to civ-47: this chapter explicitly points next to Robespierre and the French Revolution sequence.
- Broader pattern: this unit shifts the course from conquest technology into political religion and revolutionary modernity.
