#!/usr/bin/env python3
"""Insert transcript ### section anchors for civ-37 and refresh L2 refs."""
...
def update_readiness() -> None:
    ...
    needle = "| Pin-cite `civ-36` | **Done** — `scripts/part_vii_pin_cite_civ36.py` |"
    row = "| Pin-cite `civ-37` | **Done** — `scripts/part_vii_pin_cite_civ37.py` |"
...
def main() -> None:
    ...
    update_readiness()
    print("part_vii_pin_cite_civ37: done")
