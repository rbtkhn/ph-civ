...
`essay-39` sits on the ph-civ essays surface (`part: civilization`). It preserves the Substack essay as a public study packet with bounded commentary.
...
Return through `essays/essay-39/essay-39.md` for exact essay wording and `essays/essay-39/essay-39-commentary.md` for bounded analysis.
