...
`essay-43` sits on the ph-civ essays surface (`part: civilization`). It preserves the Substack essay as a public study packet with bounded commentary.
...
Return through `essays/essay-43/essay-43-transcript.md` for exact essay wording and `essays/essay-43/essay-43-commentary.md` for bounded analysis.
