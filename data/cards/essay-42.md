...
`essay-42` sits on the ph-civ essays surface (`part: civilization`). It preserves the Substack essay as a public study packet with bounded commentary.
...
Return through `essays/essay-42/essay-42-transcript.md` for exact essay wording and `essays/essay-42/essay-42-commentary.md` for bounded analysis.
