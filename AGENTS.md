...
Read `START-HERE.md`, then `llms.txt`, then `README.md`, then `docs/public-repo-contract.md` and `docs/export-contract.md`. Root layout: [`docs/onboarding/root-directory-map.md`](docs/onboarding/root-directory-map.md). Operational runbooks: [`docs/runbooks/`](docs/runbooks/).
