...
3. open the commentary canvas
4. open the public card only after the chapter floor is clear
5. use support notes only where confusion, bridge pressure, or route trouble
   appears
