...
source_chapter_path: essays/essay-41/essay-41-transcript.md
source_corpus_path: corpus/essays/essay-41.md
...
`essay-41` is a public essay packet on the ph-civ essays surface. The working thesis is that the essay should be read as an interpretive argument within the Predictive History civilizational frame, not as settled proof or operational guidance.
