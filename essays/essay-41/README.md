...
This chapter folder is a public study doorway for `essay-41`.
...
- [Transcript](essay-41-transcript.md)
- [Commentary canvas](essay-41-commentary.md)
- [Public card](../../data/cards/essay-41.md)
